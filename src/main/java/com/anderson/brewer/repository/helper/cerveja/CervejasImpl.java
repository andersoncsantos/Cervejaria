...
import com.anderson.brewer.repository.paginacao.PaginacaoUtil;
...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new com.anderson.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
